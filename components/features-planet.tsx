        ...
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            <h2 className="text-3xl font-bold text-gray-200 md:text-4xl">
              Todo lo que necesitas para dominar el trading profesional
            </h2>
          </div>
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 *:relative *:p-6 *:before:absolute *:before:bg-gray-800 *:before:[block-size:100vh] *:before:[inline-size:1px] *:before:[inset-block-start:0] *:before:[inset-inline-start:-1px] *:after:absolute *:after:bg-gray-800 *:after:[block-size:1px] *:after:[inline-size:100vw] *:after:[inset-block-start:-1px] *:after:[inset-inline-start:0] md:*:p-10">
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                12+ horas de formación estructurada en psicología, Fibonacci, risk management y ejecución. Actualizaciones constantes con nuevas estrategias y análisis del mercado.
              </p>
            </article>
            ...
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Acceso a Discord exclusivo con +2,000 traders, sesiones de análisis en vivo, y soporte directo. No estás solo en este camino, construimos juntos.
              </p>
            </article>
            ...
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Sesiones semanales de análisis del mercado en tiempo real. Ves cómo aplico la metodología en vivo, identifico setups y gestiono operaciones reales.
              </p>
            </article>
            ...
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                PDFs, plantillas de análisis, checklists de operativa y herramientas exclusivas para que tengas todo lo necesario offline y siempre a mano.
              </p>
            </article>
            ...
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Alumnos en 60+ países operando con la misma metodología. Plataforma disponible 24/7 desde cualquier dispositivo, adaptada a tu zona horaria.
              </p>
            </article>
            ...
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Un solo pago, acceso inmediato. Todas las actualizaciones futuras incluidas sin costo adicional. Tu inversión crece con cada nueva clase que agregamos.
              </p>
            </article>
          </div>
          ...
          <div className="mt-12 text-center md:mt-16">
            ...
            <p className="mt-6 text-xs text-gray-500">
              4 planes desde $497 • Garantía • Acceso inmediato
            </p>
          </div>
        </div>
      </div>
